...
chrome.tabs.query({active: true, lastFocusedWindow: true}, tabs => {
  let url = tabs[0].url;
  let urlSlice = url.slice(0,37)
 if(urlSlice == "https://membean.com/training_sessions"){
  ...
  */
  ...
  document.body.innerHTML = "<h1  >Enter a membean training session to use this extension<h1/>";
